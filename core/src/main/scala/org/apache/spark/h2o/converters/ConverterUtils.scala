...
object ConverterUtils{
  ...
  def getReadConverterContext(isExternalBackend: Boolean, keyName: String, chunkIdx: Int): ReadConverterContext ={
    val converterContext = if(isExternalBackend){
      new ExternalReadConverterContext(keyName, chunkIdx)
      null
    }else{
