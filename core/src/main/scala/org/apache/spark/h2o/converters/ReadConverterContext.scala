...
trait ReadConverterContext {
  ...
  def getByte(columnNum: Int): Byte =   getLong(columnNum).asInstanceOf[Byte]
  def getShort(columnNum: Int): Short =  getLong(columnNum).asInstanceOf[Short]
  def getInt(columnNum: Int): Int =  getLong(columnNum).asInstanceOf[Int]
  def getFloat(columnNum: Int): Float =  getLong(columnNum).asInstanceOf[Float]
